...
function showSection(sectionId, ruleName) {
    // Hide all sections
    document.querySelectorAll('.series-container, .settings-subsection, #assign_rules').forEach(div => {
    ...
    // Additional logic for settings or rules
    if (sectionId === 'settings') {
        showSettingsSection('service_status'); // Default to 'Servers' on settings load
    }
